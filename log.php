...
$mysql->query("INSERT INTO `users` (`fullname`, `dateofbirth`, `email`, `mobile`, `gender`, `password`, `yourcourse`, `uniid`, `degreelevel`, `speciality`, `numberofgroup`, `language`)
    VALUES('$fullname', '$dateofbirth', '$email', '$mobile', '$gender', '$password', '$yourcourse', '$uniid', '$degreelevel', '$speciality', '$numberofgroup', '$language')"); 

$result = $mysql->query("SELECT * FROM `users` (`fullname`, `dateofbirth`, `email`, `mobile`, `gender`, `password`, `yourcourse`, `uniid`, `degreelevel`, `speciality`, `numberofgroup`, `language`)
